...
export default function ExamCreator() {
    ...
    const handleSaveExam = async () => {
        ...
        if (Object.keys(examErrors).length > 0) {
    ...
    const handleAddQuestion = async () => {
        ...
        try {
            const res = await api.addQuestionToExam(examId, questionData);
            unstable_batchedUpdates(() => {
                    ...
                    <div>
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setQuestionData({ ...questionData, optionA: e.target.value })
                                }/>
                        </label>
                        {errors.optionA && (
                            <span style={{ color: "red" }}>{errors.optionA}</span>
                        )}
                    </div>
                    <div>
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setQuestionData({ ...questionData, optionB: e.target.value })
                                }/>
                        </label>
                        {errors.optionB && (
                            <span style={{ color: "red" }}>{errors.optionB}</span>
                        )}
                    </div>
                    <div>
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setQuestionData({ ...questionData, optionC: e.target.value })
                                }/>
                        </label>
                        {errors.optionC && (
                            <span style={{ color: "red" }}>{errors.optionC}</span>
                        )}
                    </div>
                    <div>
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setQuestionData({ ...questionData, optionD: e.target.value })
                                }/>
                        </label>
                        {errors.optionD && (
                            <span style={{ color: "red" }}>{errors.optionD}</span>
                        )}
                    </div>
                    <div>
                        <label>
